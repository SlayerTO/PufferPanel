						...
						<table>
							...
							<tr>
								<td>
									...
									<p>Hello there! This email is to inform you that you have been invited to help manage the following server: <a href="{{ MASTER_URL }}index"><i>{{ SERVER }}</i></a>. Simply login to the panel to gain access to this server.</p>
